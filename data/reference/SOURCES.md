...
## nagano_official_urls.json — 長野県の市町村公式URL
- 出典: 長野県「市町村一覧（役場所在地・電話番号等）」 https://www.pref.nagano.lg.jp/shichoson/kensei/shichoson/gappei/gappei/mejiiko/ichiran/index.html
- 取得日: 2026-09-10 / 77市町村の公式サイトURL（コード表と突き合わせ）
- 用途: 命名規則で公式ドメインを推測できない町村（vanity ドメイン等）の解決に使う。県の公的一覧が運営主体を保証する
